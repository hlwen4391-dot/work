...
const heros = [
    new Hero({ name: "战士", hp: 150, attack: 15, defense: 10, speed: 20, crit: 0.6, attackWindow: 200, attackCooldown: 300, skills: [stunSkill] }),
...
const monsters = [
    new Monster({ name: "小兵", hp: 50, attack: 1, defense: 1, speed: 10, attackWindow: 200, attackCooldown: 300 }),
    new Monster({ name: "野怪", hp: 80, attack: 5, defense: 3, speed: 9 }),
    new Monster({ name: "巨狼", hp: 100, attack: 10, defense: 5, speed: 8, skills: [rageSkill] }),
